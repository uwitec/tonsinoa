        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string node = context.Request["node"];
             if (param == "root")
             {
                 ...
                 nodes.Add(new ExtTreeNode() { TypeTitle = "工作报告总结", TypeEName = "工作报告总结", text = "工作报告总结", TypeID = "2", id = "2", IsRoot = false, leaf = false, draggable = false, PID = "0", parentNodeId = "0" });
                 ...
                 nodes.Add(new ExtTreeNode() { TypeTitle = "BBS论坛", TypeEName = "BBS论坛", text = "BBS论坛", TypeID = "5", id = "5", IsRoot = false, leaf = false, draggable = false, PID = "0", parentNodeId = "0" });
             ...
             else
             {
                 ...
                 switch (node)
                 {
                     ...
                     case "6":
                         ...
                         nodes.Add(new ExtTreeNode { TypeTitle = "部门设置", TypeEName = "部门设置", text = "部门设置", TypeID = "601", id = "601", IsRoot = false, leaf = true, PID = node });
